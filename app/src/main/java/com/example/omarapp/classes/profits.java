...
import static com.example.omarapp.database.TablesString.SaleTable.*;
...
public class profits implements SqlInterface {
    private int salesid;
    private int prodid;
    ...
    //region Constructors
    public profits(int salesid, int salesprod, String salesuser) {
